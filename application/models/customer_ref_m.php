...
{	
	...
	function get_by_nomor_pemesanan($nomor_pemesanan)
	{
		$query = $this->db->query("SELECT * FROM tbl_resepsionis WHERE nomor_pemesanan = '".mysql_real_escape_string($nomor_pemesanan)."'");
		return $query;
	}
