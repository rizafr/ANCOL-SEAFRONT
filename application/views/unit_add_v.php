...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#id_cluster").change(function(){
			...
			$('#id_type').html('<option value=""> -- Pilih Hadap -- </option>');
			$('#kode_blok').html('<option value=""> -- Pilih Floor -- </option>');
		...
		$("#id_type").change(function(){
			...
			if(kode_blok != "" )
			{
				var opt = '<option value=""> -- Pilih Floor -- </option>';
...
<div class="margin_center" style="width:1002px">	
	...
	<div class="frame_tabel radius transparent" style="width:1000px">
		<form name="form_add" id="form_add" method="post" action="<?php echo $action; ?>">
			<table width="427px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				<tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>Tower<span class="required_star">*</span></strong></div></td>
					<td>
						<div class="isi_tabel">
							<select name="id_cluster" id="id_cluster">
								<option value="" data-kode-cluster="" > -- Pilih Tower -- </option>
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>Hadap<span class="required_star">*</span></strong></div></td>
					<td>
						<div class="isi_tabel">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<input type="text" name="kode_cluster" id="kode_cluster" size="8" value="<?php echo set_value('kode_cluster'); ?>" placeholder="Kd. Tower" style="text-align:center;">
							 / 
			...
			<table width="470px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>Cash Keras</strong></div></td>
					<td><div class="isi_tabel">
						<input type="text" name="harga_jual_inc_ppn" id="harga_jual_inc_ppn" size="30" value="<?php echo set_value('harga_jual_inc_ppn', 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><div class="isi_tabel">
						<input type="text" name="plafon_kpr" id="plafon_kpr" size="30" value="<?php echo set_value('plafon_kpr', 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>CB 36x</strong></div></td>
					<td><div class="isi_tabel">
						<input type="text" name="kpr_5_tahun" id="kpr_5_tahun" size="30" value="<?php echo set_value('kpr_5_tahun', 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>CB 48x</strong></div></td>
					<td><div class="isi_tabel">
						<input type="text" name="kpr_10_tahun" id="kpr_10_tahun" size="30" value="<?php echo set_value('kpr_10_tahun', 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong></strong></div></td>
					<td><div class="isi_tabel">
						<input type="hidden" name="kpr_15_tahun" id="kpr_15_tahun" size="30" value="<?php echo set_value('kpr_15_tahun', 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)" readonly="readonly">
					</div></td>
				</tr>
