...
<div class="margin_center" style="width:100%;">
    ...
    <div id="frame_pagging" class="shadow radius">
        ...
        if ($next < $total_pemesanan) {
            ...
            <a href="javascript:void(0);" onClick="javascript:list(<?php echo $akhir; ?>);
                        return false;">
                <div id="tombol_navigasi">Terakhir</div>
            </a>
            <a href="javascript:void(0);" onClick="javascript:list(<?php echo $next; ?>);
                        return false;">
        ...
        if ($prev >= 0) {
            ...
            <a href="javascript:void(0);" onClick="javascript:list(<?php echo $prev; ?>);
                        return false;">
                <div id="tombol_navigasi">Sebelumnya</div>
            </a>
            <a href="javascript:void(0);" onClick="javascript:list(0);
                        return false;">
