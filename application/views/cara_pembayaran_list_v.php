<div class="margin_center" style="width:1000px">
    ...
    <div class="tombol_tambah" style="margin-right:500px;">
        <a href="" onClick="javascript:add();
                        return false;"><input type="button" value="Tambah Data &#43;"></a>
    </div>
    <div class="clear"></div>
        ...
        <table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
            ...
            foreach ($cara_pembayaran as $data_cara_pembayaran) {
                ...
                <tr id="<?php echo $data_cara_pembayaran->id_cara_pembayaran; ?>" class="hover">
                    ...
                    <td align="center">
                        <a href="" onClick="javascript:edit(<?php echo $data_cara_pembayaran->id_cara_pembayaran; ?>);
                                                            return false;" title="Ubah">
                            <div class="isi_tabel">
                    ...
                    <td align="center">
                        <a href="" onClick="javascript:hapus(<?php echo $data_cara_pembayaran->id_cara_pembayaran; ?>);
                                                            return false;" title="Hapus">
                            <div class="isi_tabel">
