...
if ($this->access_lib->_if("adm")) {
    ...
    <div id="top_panel">
        ...
        <div class="list_menu" id="menu_report">
            ...
            <div class="submenu" id="submenu">
                <ul class="root">				
                    ...
                    <li><a href="<?php echo base_url(); ?>report/refund_data">Booking Refund</a></li>
        ...
        <div class="list_menu" id="menu_booking">
            ...
            <div class="submenu" id="submenu3">
                <ul class="root">				
                    ...
                    <li><a href="<?php echo base_url(); ?>resepsionis">Daftar Tamu</a></li>
                    <li><a href="<?php echo base_url(); ?>resepsionis/antrian">No Antrian</a></li>
                    <li><a href="<?php echo base_url(); ?>resepsionis/tampilan1">View 1</a></li>
                </ul>
            </div>
        </div>
        <div class="list_menu" id="menu_master">
            ...
            <div class="submenu" id="submenu2">
                <ul class="root">				
                    <li><a href="<?php echo base_url(); ?>cluster">Tower</a></li>
                    ...
                    <li><a href="<?php echo base_url(); ?>komisi">Komisi</a></li>
                    <li><a href="<?php echo base_url(); ?>sk">SK</a></li>
                </ul>
            </div>
        </div>
        <div class="list_menu">
    ...
    <?php echo $nama_perusahaan; ?>
        ...
        <div class="list_menu"><a href="<?php echo base_url(); ?>produk">Tower</a></div>
    ...
    <?php
} elseif ($this->access_lib->_if("res")) {
    ?>
    <div id="top_panel">
    <?php echo $nama_perusahaan; ?>
        <div class="list_menu" style="color:#03A9F4;"><a href="<?php echo base_url(); ?>login/logout" style="color:#03A9F4;">Logout</a></div>
