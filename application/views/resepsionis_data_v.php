						...
						<tr>
							...
							<td align="center">
								<?php if($data_pemesanan->status_kehadiran=='0') {?>
									<a href="javascript:void(0);" title="Verify" onClick="javascript:verify(<?php echo $data_pemesanan->nomor_pemesanan; ?>); return false;">
										<div class="isi_tabel">
							...
							<?php
								...
								<td align="center">
									<?php if($data_pemesanan->status_transaksi=='0') {?>
										<a href="javascript:void(0);" title="transaksi"  onClick="javascript:transaksi(<?php echo $data_pemesanan->nomor_pemesanan; ?>,<?php echo $data_pemesanan->nomor_pemesanan; ?>); return false;">
											<div class="isi_tabel">
							...
							<?php } ?>
							<td align="center">
								<a href="<?php echo base_url(); ?>resepsionis/resepsionis_detail/<?php echo $data_pemesanan->id_unit."/".$data_pemesanan->id_kartu_keluarga."/".$data_pemesanan->nomor_pemesanan; ?>" title="Tampilkan" >
									<div class="isi_tabel">
