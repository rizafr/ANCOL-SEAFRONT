        ...
        <div class="margin_center" style="width:1002px">
            ...
            <div class="frame_tabel radius transparent">	
                <table style="width:100%;" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td rowspan="3" class="header_tabel_cust"><div style="color:#FFF; text-align:center;">Tower</div></td>
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td rowspan="2" class="header_tabel_cust"><div style="color:#FFF; text-align: center;">KPA 36x</div></td>
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td class="header_tabel_cust"><div style="color:#FFF; text-align: center;">CB 36X</div></td>
                        <td class="header_tabel_cust"><div style="color:#FFF; text-align: center;">CB 48X</div></td>
                    </tr>
                    </thead>		
            ...
            <div class="frame_tabel radius transparent" style="width:1002px" id="td-height">
                <form name="pemesanan" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>report/unit_sold_edit" onSubmit="return validasi();">
                    <table width="1002px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
                        <tr bgcolor="#FFFFFF">
                    ...
                    <table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td style="height:65px;" valign="top" bgcolor="#999999"><div class="isi_tabel"><strong>Alamat KTP</strong></div></td>
                            <td valign="top">
                                <div class="isi_tabel">
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td style="height:65px;" valign="top" bgcolor="#999999"><div class="isi_tabel"><strong>Alamat NPWP</strong></div></td>
                            <td valign="top">
                                <div class="isi_tabel">
