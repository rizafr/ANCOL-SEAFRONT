<div class="margin_center" style="width:1010px;margin-top:-50px">	
	...
	<div class="clear">
		...
		<div id="slidorion" class="slidorion">
			<div class="slider">
				<div class="slide"><img style="max-width:680px; max-height:500px" src="<?php echo base_url().'files/slide/'.$data_news->image; ?>" /></div>
			</div>
