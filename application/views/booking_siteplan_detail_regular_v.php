	...
	<div id="frame-sp">
		...
		foreach($unit as $data_unit)
		{
			...
			$data_unit->luas_bangunan.'"';
				...
				{
					$color = 'data-maphilight=\'{"fillColor":"00FF00"}\' href="'.base_url().'booking/form_pemesanan/add/'.$data_siteplan->id_siteplan.'/'.$data_unit->id_unit.'" onclick="return confirm(\'Anda yakin akan memilih unit ini?\')"';
				}	
