...
<div class="margin_center" style="width:1000px">	
	...
	<div class="frame_tabel radius transparent" style="width:1002px">
			<table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999" class="isi_tabel"><strong>Tower</strong></td>
					<td class="isi_tabel"><?php echo $data_unit->nama_cluster; ?></td>
				</tr>
				
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999" class="isi_tabel"><strong>Hadap</strong></td>
