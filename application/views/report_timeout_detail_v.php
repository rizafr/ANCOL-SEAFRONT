...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1005px">
		...
		<div class="frame_tabel radius transparent">	
			<table style="width:100%;" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					...
					<td rowspan="3" class="header_tabel_cust"><div style="color:#FFF; text-align:center;">Harga Cash Keras</div></td>
				...
				<tr bgcolor="#FFFFFF">
					<td class="header_tabel_cust"><div style="color:#FFF; text-align: center;">Semi Gross</div></td>
