	...
	<div class="margin_center" style="width:1000px; margin-bottom:20px;">
		...
		<div class="frame_tabel radius" >
			<table width="600px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				...
				<tr bgcolor="#FFFFFF">
					<td width="150px" bgcolor="#999999"><div class="header_tabel"><strong>Tower</strong></div></td>
	...
	<div id="frame-sp">
		...
		foreach($unit as $data_unit)
		{
			...
			$data_unit->luas_bangunan.'"';
				...
				{
					$color = 'data-maphilight=\'{"fillColor":"0099CC"}\' href="javascript:void(0);"';
				}
				...
				{
//					$color = 'data-maphilight=\'{"fillColor":"00FF00"}\' href="'.base_url().'booking/pindah/'.$pemesanan->nomor_pemesanan.'/'.$data_siteplan->id_siteplan.'/'.$data_unit->id_unit.'" onclick="return confirm(\'Anda yakin akan pindah unit?\')"';
				}	
