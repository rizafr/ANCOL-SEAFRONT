...
<div id="frame_data">
	<div class="margin_left" style="width:910px">		
		<div class="header_data">Tambah Data Hadap</div>
		...
		<div class="frame_tabel radius" style="margin-bottom:10px;">
			<table width="700px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					<td width="150px" bgcolor="#999999"  class="header_tabel"><strong>Nama Tower</strong> </td>
		...
		<div class="frame_tabel radius transparent">
			<table width="700px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><b>Nama Hadap<span class="required_star">*</span></b></div></td>
					<td>
						<div class="isi_tabel">
			...
			<table width="170px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				...
				foreach($kode_blok AS $kb)
				{
					if($i == 1)
					{
						echo '
						<tr bgcolor="#FFFFFF">
							<td bgcolor="#999999"><div class="isi_tabel"><b>Floor</b></div></td>
							<td>
								<div class="isi_tabel">
