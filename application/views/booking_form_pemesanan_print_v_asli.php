...
<?php
	...
	$path_phpword= <?php echo base_url()?>."application/libraries/PHPWord.php";
	// include '../application/libraries/PHPWord.php';
	include $path_phpword;

	// Create a new PHPWord Object
	$PHPWord = new PHPWord();
		
		
	$document = $PHPWord->loadTemplate('../files/template/rppTemplate.doc');
	
	//isi surat
	//data penduduk awal
	$document->setValue('nama', $pemesanan->nama_lengkap);
	$document->setValue('alamatKtp', $pemesanan->alamat_ktp);
	$path='E:\\';
	
<<<<<<< HEAD
	
=======
	$namafile = $pemesanan->nama_lengkap."_"."_".date('d F Y').".docx";
	// $document->save('E:\\andonnikahTemplate.docx');
	//$document->save('E:\\'.$nama_file);
>>>>>>> c5b9c39a7ca9a7a881c8efa44f66a4060fc39b67
