...
<div class="margin_center" style="width:98%">
    ...
    <div class="tombol_tambah">
        <?php
			...
			?>
            <a href="" onClick="javascript:add(<?php echo $posisi . ", " . $show . ", '" . $key . "'"; ?>);
			return false;"><input type="button" value="Tambah Stok &#43;"></a>
            <?php
			}
		?>	
	</div>
		...
		<table cellspacing="1px" cellpadding="1px">
					...
					<div class="isi_tabel">
						<span id="frame_order_by">
							<select name="order_by" id="order_by">
								...
								<option value="u.kategori" <?php if ($order_by == "u.kategori") {
									echo "selected";
								} ?>>Kategori</option>
								<option value="c.nama_cluster" <?php if ($order_by == "c.nama_cluster") {
									echo "selected";
								} ?>>Tower</option>
								<option value="t.nama_type" <?php if ($order_by == "t.nama_type") {
									echo "selected";
								} ?>>Type</option>
								<option value="u.kode_unit" <?php if ($order_by == "u.kode_unit") {
									echo "selected";
								} ?>>Kode Unit</option>
								<option value="u.status_unit" <?php if ($order_by == "u.status_unit") {
									echo "selected";
								} ?>>Status Stok</option>
								<option value="u.status_transaksi" <?php if ($order_by == "u.status_transaksi") {
									echo "selected";
								} ?>>Status Transaksi</option>
							</select>
						</span>
						<span id="frame_sort_by">
							<select name="sort_by" id="sort_by">
								<option value=""> -- Metode Pengurutan -- </option>
								<option value="ASC" <?php if ($sort_by == "ASC") {
									echo "selected";
								} ?>>Kecil ke Besar</option>
								<option value="DESC" <?php if ($sort_by == "DESC") {
									echo "selected";
								} ?>>Besar ke Kecil</option>
							</select>
						</span>
					</div>
				</td>
            ...
            <tr bgcolor="#FFFFFF">
				<td bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;">Pencarian </td><td>
					<div class="isi_tabel">
						<input type="text" value="<?php echo $filter_kode_cluster; ?>" size="8" name="filter_kode_cluster" id="filter_kode_cluster" placeholder="Kd. Tower" style="text-align:center;"> <strong>/</strong>
            ...
            <tr bgcolor="#FFFFFF">
				...
				<td>
					<div class="isi_tabel">
						<a href="" onClick="javascript:list_data(0, document.getElementById('show').value, '');
						return false;">
							<input type="button" value="Tampilkan">
						</a>
						<a href="" onClick="javascript:list_data(0, document.getElementById('show').value, 'all');
						return false;">
						...
						<?php
							if ($this->access_lib->_if("adm,stk")) {
							?>
							<a href="" onClick="javascript:reset_promo();
							return false;">
	...
	<div class="frame_tabel_cust radius transparent content fluid light" id="unit_list" style="float:none; overflow:auto;">
		<table style="white-space:nowrap;" width="100%" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
            <thead>
				<tr bgcolor="#FFFFFF">
					...
					<td rowspan="3" class="header_tabel_cust center"> Tower </td>
					...
					<td rowspan="3" class="header_tabel_cust center"> Cash Keras</td>
					<td rowspan="3" class="header_tabel_cust center">Booking Fee </td>
					<td rowspan="3" class="header_tabel_cust center"> CB 36X </td>
					<td rowspan="3" class="header_tabel_cust center"> CB 48X </td>
					<td rowspan="3" class="header_tabel_cust center"> KPA 24X 40% </td>		
					<td rowspan="3" class="header_tabel_cust center"> KPA 36X 40% </td>		
				...
				<tr bgcolor="#FFFFFF">
					...
					<td class="header_tabel_cust center"> Semi Gross </td>
				...
				<tr id="tr_<?php echo $data_unit->id_unit; ?>" class="hover">
					...
					<?php
						if ($this->access_lib->_if("adm,stk")) {
							...
							$ceksua = '';
							$ceksue = '';
							if ($data_unit->status_unit == "Master") {
								$ceksum = 'checked="checked"';
								} elseif ($data_unit->status_unit == "Marketable") {
								$ceksua = 'checked="checked"';
								} elseif ($data_unit->status_unit == "Promo") {
								$ceksue = 'checked="checked"';
							}
						...
						<td class="isi_tabel center">
						<a href="" title="Tampilkan" onClick="javascript:detail(<?php echo $data_unit->id_unit . "," . $posisi . "," . $show . ", ''"; ?>);
						return false;">
						...
						<td class="isi_tabel center">
						<a href="" title="Ubah" onClick="javascript:edit(<?php echo $data_unit->id_unit . ", " . $posisi . ", " . $show . ", '" . $key . "'"; ?>);
						return false;">
						...
						<td class="isi_tabel center">
						<a href="" title="Hapus" onClick="javascript:hapus(<?php echo $data_unit->id_unit . "," . $posisi . ", " . $show . ", '" . $key . "'"; ?>);
						return false;">
						...
						<a href="" onClick="javascript:list_data(<?php echo $akhir . ", " . $show . ", ''"; ?>);
						return false;">
						<div id="tombol_navigasi">Terakhir</div>
						</a>
						<a href="" onClick="javascript:list_data(<?php echo $next . ", " . $show . ", ''"; ?>);
						return false;">
						...
						<div class="data_nav">
						Data ke <?php if ($posisi == 0 AND count($unit) == 0) {
						echo "0";
						...
						<a href="" onClick="javascript:list_data(<?php echo $prev . ", " . $show . ", ''"; ?>);
						return false;">
						<div id="tombol_navigasi">Sebelumnya</div>
						</a>
						<a href="" onClick="javascript:list_data(0, <?php echo $show . ", ''"; ?>);
						return false;">
