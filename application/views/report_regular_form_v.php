    ...
    <div id="frame_data">
        ...
        <div class="margin_center" style="width:1000px">
            ...
            <div class="frame_tabel radius transparent" style="width:1003px" id="td-height">
                <form action="<?php echo base_url(); ?>report/regular_edit/<?php echo $pemesanan->nomor_pemesanan; ?>" method="post" enctype="multipart/form-data" name="pemesanan" onSubmit="return validasi();">
                    ...
                    <table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
                        <tr bgcolor="#FFFFFF">
                            <td width="200" bgcolor="#999999"><div class="isi_tabel"><strong>Nomor Virtual Account</strong></div></td>
                            <td>
                                <div class="isi_tabel">
                                    <input type="text" name="no_va" id="no_va" size="40" value="<?php echo $pemesanan->no_va; ?>" readonly="readonly">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td>
                                <div class="isi_tabel">
                                    <input type="text" name="nup" id="nup" size="40" value="<?php echo $pemesanan->nomor_pemesanan; ?>" readonly="readonly">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td bgcolor="#999999"><div class="isi_tabel"><strong>No. NPWP</div></td>
                            <td>
                                <div class="isi_tabel">
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td bgcolor="#999999"><div class="isi_tabel"><strong>Telpon</div></td>
                            <td>
                                <div class="isi_tabel">
                    ...
                    <table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">				
                        ...
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td>
                                <div class="isi_tabel">
                                    <input type="text" name="diskon_khusus" id="diskon_khusus" size="20" value="<?php echo $pemesanan->diskon_khusus; ?>" style="text-align:right;">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td bgcolor="#999999"><div class="isi_tabel"><strong>Dok. KTP</div></td>
                            <td>
                                <div class="isi_tabel">
