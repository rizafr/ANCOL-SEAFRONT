        ...
        <table width="100%" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
            ...
            foreach ($pemesanan as $data_pemesanan) {
                ...
                <tr class="hover">
                    ...
                    <?php
                    if ($this->access_lib->_if("adm,mgr,ksr,sal")) {
                        ?>
                        <td align="center">
    ...
    if ($status_cari == "cari") {
        ...
        <div id="frame_pagging" class="shadow radius">
            ...
            if ($next < $total_pemesanan) {
                ...
                <a href="<?php echo base_url(); ?>report/regular_list/<?php echo $akhir; ?>" onClick="javascript:tampilkan_list(<?php echo $akhir ?>);
                                return false;">
                    <div id="tombol_navigasi">Terakhir</div>
                </a>
                <a href="<?php echo base_url(); ?>report/regular_list/<?php echo $next; ?>" onClick="javascript:tampilkan_list(<?php echo $next ?>);
                                return false;">
                    <div id="tombol_navigasi">Berikutnya</div>
                </a>
        ...
        if ($posisi == 0 AND count($pemesanan) == 0) {
            ...
            if ($prev >= 0) {
                ...
                <a href="<?php echo base_url(); ?>report/regular_list/<?php echo $prev; ?>" 
                   onClick="javascript:tampilkan_list(<?php echo $prev; ?>);
                                   return false;">
                    <div id="tombol_navigasi">Sebelumnya</div>
                </a>
                <a href="<?php echo base_url(); ?>report/regular_list/0" 
