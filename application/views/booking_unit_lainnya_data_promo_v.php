<div class="margin_center" style="width:98%;">
        ...
        <table width="100%" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
            ...
            foreach ($unit as $data_unit) {
                ...
                <tr class="hover">
                    ...
                    <td><div class="isi_tabel"> <?php echo $data_unit->nama_type . " " . $data_unit->posisi;
            ; ?> </div></td>
                    <td align="center">
                        <div class="isi_tabel"> 				
    ...
    if ($next < $total_unit) {
        ?>
                ...
                <a href="" onClick="javascript:list(<?php echo $akhir; ?>);
                                return false;">
                    <div id="tombol_navigasi">Terakhir</div>
                </a>
                <a href="" onClick="javascript:list(<?php echo $next; ?>);
                                return false;">
    ...
    ?>
        ...
        echo $posisi + 1;
            ...
            if ($prev >= 0) {
                ...
                <a href="" onClick="javascript:list(<?php echo $prev; ?>);
                                return false;">
                    <div id="tombol_navigasi">Sebelumnya</div>
                </a>
                <a href="" onClick="javascript:list(0, <?php echo $show; ?>);
                                return false;">
