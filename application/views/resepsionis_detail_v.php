...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>resepsionis/resepsionis/0"><input type="button" value="&laquo; Kembali"></a>
		</div>	
		...
		<div class="frame_tabel radius transparent" style="width:1002px" id="td-height">		
			<table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>Telepon<strong></strong></strong></div></td>
					<td>
						<div class="isi_tabel">
