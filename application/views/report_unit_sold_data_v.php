...
<div class="frame_tabel radius transparent" style="margin-bottom: 3px;">
	<table cellspacing="1px" cellpadding="1px" >
		<tr bgcolor="#FFFFFF">
			<td width="160px" bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;">
		...
		<tr bgcolor="#FFFFFF">
			<td width="160px" bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;">
					<input type="radio" name="filter" value="cluster" <?php if($filter == "cluster"){ echo "checked"; } ?>>&nbsp;Nama Tower 
			</td>
			<td>
				<div class="isi_tabel">
		...
		<tr bgcolor="#FFFFFF">
			<td width="160px" bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;">&nbsp; </td>
			<td  class="isi_tabel" style="margin-right:3px;">
