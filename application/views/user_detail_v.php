...
<div class="margin_left" style="width:600px">		
    ...
    <div class="tombol_tambah">
        <a href="" onClick="javascript:edit(<?php echo $user->id_user . ", " . $posisi . "," . $key; ?>);
                return false;"><input type="button" value="Ubah"></a>
        <a href="" onClick="javascript:list_data(<?php echo $posisi . "," . $key; ?>);
                return false;"><input type="button" value="&laquo; Kembali"></a>
    </div>
    <div class="frame_tabel radius transparent">
        <table width="600px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td><div class="isi_tabel"><?php echo $user->tempat_lahir . ", ";
                        ubah_format_tanggal($user->tanggal_lahir); ?></div></td>
            </tr>			
            <tr bgcolor="#FFFFFF">
