...
<div class="margin_center" style="width:1002px">	
	...
	<div class="frame_tabel radius transparent" style="width:1005px">
		<form name="form_edit" id="form_edit" method="post" action="<?php echo $action; ?>">
			<table width="400px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				<tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<input type="text" name="kode_cluster" id="kode_cluster" size="8" value="<?php echo $kode_cluster; ?>" placeholder="Kd. Tower" style="text-align:center;">
							 / 
			...
			<table width="472px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><div class="isi_tabel">
						<input type="text" name="harga_jual_inc_ppn" id="harga_jual_inc_ppn" size="30" value="<?php echo number_format($data_unit->harga_jual_inc_ppn, 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)" >
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><div class="isi_tabel">
						<input type="text" name="kpr_5_tahun" id="kpr_5_tahun" size="30" value="<?php echo number_format($data_unit->kpr_5_tahun, 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><div class="isi_tabel">
						<input type="text" name="kpr_10_tahun" id="kpr_10_tahun" size="30" value="<?php echo number_format($data_unit->kpr_10_tahun, 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)">
					</div></td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong></strong></div></td>
					<td><div class="isi_tabel">
						<input type="hidden" name="kpr_15_tahun" id="kpr_15_tahun" size="30" value="<?php echo number_format($data_unit->kpr_15_tahun, 0); ?>" style="text-align:right;" onkeypress="return isNumberKey(event)" readonly="readonly">
					</div></td>
				</tr>
