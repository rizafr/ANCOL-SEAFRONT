<div class="margin_center" style="width:1000px">	
	...
	<div class="frame_tabel radius transparent" style="margin-bottom: 3px;">
		<table cellspacing="1px" cellpadding="1px">
			<tr bgcolor="#FFFFFF">
				<td width="80px" bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;">Jenis Pencarian</div></td>
				<td>
					<div class="isi_tabel">
				...
				<tr bgcolor="#FFFFFF" id="tr-tanggal">
					<td bgcolor="#0066FF"  class="header_tabel_cari" style="height: 100%;">Tanggal</div></td>
					<td>
						<div class="isi_tabel">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#0066FF"  class="header_tabel_cari" style="height: 100%;">Data perhalaman</div></td><td>
						<div class="isi_tabel">
				...
				<tr bgcolor="#FFFFFF">
					<td width="150px" bgcolor="#0066FF"  class="header_tabel_cari" style="height: 100%;">&nbsp;</div></td>
					<td>
						<div class="isi_tabel">
	...
	<div class="frame_tabel radius transparent">
		<table width="1000px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			<tr bgcolor="#0066FF">
				<td width="150px" class="header_tabel"> Tanggal </div></td>
				<td width="120px"  class="header_tabel"> Username </div></td>
				<td class="header_tabel"> Keterangan </div></td>
				<td width="120px"  class="header_tabel"> IP Address </div></td>
			</tr>
