<div class="margin_center" style="width:1000px">	
	<div class="header_data">Data Tower</div>
	...
	<div class="frame_tabel radius transparent" style="margin-bottom: 3px;">
		<table cellspacing="1px" cellpadding="1px">
			<tr bgcolor="#FFFFFF">
				<td width="150px" bgcolor="#0066FF" class="header_tabel_cari" style="height: 100%;"> Nama Tower </td>
				<td class="isi_tabel">
	...
	<div class="frame_tabel radius transparent">
		<table width="1000px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			<tr bgcolor="#FFFFFF">
				<td width="800px" class="header_tabel"> Nama Tower </td>
				<td width="100px" class="header_tabel"> Kode Tower </td>
