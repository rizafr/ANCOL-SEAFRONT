...
class Header_lib{
	...
	function dashboard_header()
	{
		...
		<script type="text/javascript" src="'.base_url().'files/js/jquery.js"></script>
		<script type="text/javascript" src="'.base_url().'files/scroll/jquery.mCustomScrollbar.concat.min.js"></script>
		<link rel="stylesheet" href="'.base_url().'files/scroll/jquery.mCustomScrollbar.css">
