...
//        }
    ...
    public function regular_edit($nomor_pemesanan) {
        $this->load->model('pemesanan_m');
        $this->load->model('customer_m');
...
//        }
        ...
        $this->kartu_keluarga_m->edit_kartu_keluarga(
                $this->input->post('id_kartu_keluarga'), array("no_kartu_keluarga" => $this->input->post('no_kartu_keluarga'))
        );
    ...
    public function regular_detail($id_unit, $id_kartu_keluarga, $id_pemesanan) {
        ...
        $data['anggota_keluarga'] = $this->kartu_keluarga_m->get_all_anggota_keluarga($id_kartu_keluarga)->result();
        $data['pemesanan'] = $this->pemesanan_m->get_by_id($id_pemesanan)->row();
        $data['siteplan'] = $this->siteplan_m->get_siteplan($id_unit)->row();
        $data['dokumen_lainnya'] = $this->customer_m->get_dokumen_by_id_customer($data['pemesanan']->id_customer)->result();
        $data['id_unit'] = $id_unit;
        $data['id_kartu_keluarga'] = $id_kartu_keluarga;
        $data['id_pemesanan'] = $id_pemesanan;
    ...
    public function refund_list($limit) {
        $this->load->model('pemesanan_m');
        $this->load->model('cluster_m');

        $data['pemesanan'] = $this->pemesanan_m->get_by_jenis('limit', 'Refund', $limit, '', '', '', '', '')->result();
        $data['total_pemesanan'] = count($this->pemesanan_m->get_by_jenis('all', 'Promo', 0, '', '', '', '', '')->result());
        $data['cluster'] = $this->cluster_m->get_all("all", 0)->result();
        ...
        $this->load->view('report_refund_data_v', $data);
    }

    public function refund_cari_list($limit, $filter, $id_cluster, $kategori, $kata_kunci) {
        $this->load->model('pemesanan_m');
        $this->load->model('cluster_m');
    ...
    public function refund_form($id_unit, $id_kartu_keluarga, $id_pemesanan) {
        $this->load->model('unit_m');
        $this->load->model('pemesanan_m');
        $this->load->model('customer_m');
        $this->load->model('kartu_keluarga_m');
        $this->load->model('cara_pembayaran_m');
        $this->load->model('refund_m');
        ...
        $data['diskon_cara_pembayaran'] = $this->refund_m->get_max_diskon($id_unit)->result();
        $data['data_cara_pembayaran'] = $data['diskon_cara_pembayaran'];
        ...
        $data["status"] = $data["pemesanan"]->jenis_pemesanan;
        $data['nama_refund'] = $data["pemesanan"]->nama_refund;
        $data['deskripsi'] = $data["pemesanan"]->deskripsi;

        $this->load->view('report_refund_form_v', $data);
    }
    ...
    public function refund_edit() {
        ...
        $this->access_lib->logging("Ubah data pemesanan refund : " . $now_pemesanan->nomor_pemesanan . " (" . $this->input->post('status_pemesanan') . ")");

        redirect('report/refund_anggota_keluarga/' . $this->input->post('id_unit') . '/' . $this->input->post('id_kartu_keluarga') . '/' . $this->input->post('id_pemesanan'));
    }

    public function refund_anggota_keluarga($id_unit, $id_kartu_keluarga, $id_pemesanan) {
        $this->load->model('unit_m');
        $this->load->model('pemesanan_m');
        $this->load->model('kartu_keluarga_m');
        ...
        $this->load->view('report_refund_kartu_keluarga_v', $data);
    }

    public function refund_anggota_keluarga_add() {
        $this->load->model('kartu_keluarga_m');
    ...
    public function refund_anggota_keluarga_delete($id_anggota_keluarga) {
        $this->load->model('kartu_keluarga_m');
        $this->kartu_keluarga_m->delete_anggota_keluarga($id_anggota_keluarga);
    }

    public function refund_preview($id_unit, $id_kartu_keluarga, $id_pemesanan) {
        $this->load->model('unit_m');
        $this->load->model('pemesanan_m');
        $this->load->model('customer_m');
        $this->load->model('kartu_keluarga_m');
        ...
        $this->load->view('report_refund_preview_v', $data);
    }

    public function refund_detail($id_unit, $id_kartu_keluarga, $id_pemesanan) {
        $this->load->model('unit_m');
        $this->load->model('pemesanan_m');
        $this->load->model('customer_m');
        $this->load->model('kartu_keluarga_m');
        ...
        $this->load->view('report_refund_detail_v', $data);
    }

    public function refund_delete($id_pemesanan, $id_unit) {
        $this->access_lib->_is("adm,mgr,ksr");
        ...
        $this->access_lib->logging("Hapus data pemesanan refund : " . $data_pemesanan->nomor_pemesanan);
    }
    ...
    public function refund($id_pemesanan) {
        $this->access_lib->_is("adm,mgr,ksr");
        ...
        $data = array("status_pemesanan" => "Refund",
            "status_verify" => "Refund",
            "tanggal_tanda_jadi" => $tanggal_tanda_jadi,
            "timeout" => $timeout
        );
        $this->pemesanan_m->edit($id_pemesanan, $data);
        ...
        $data_unit = $this->unit_m->get_by_id($data_pemesanan->id_unit)->row();

        $data = array("status_transaksi" => ""
        );
        $this->unit_m->edit($data_unit->id_unit, $data);

        $show_status_pemesanan = "Refund";
        $show_status_verify = "Refund";

        $this->access_lib->logging('Verify pemesanan : ' . $nomor_pemesanan . ' ["Refund (Verified)" -> "Refund"]');
        echo $show_status_pemesanan . "|" . $show_status_verify . "|" . $tanggal_exp . "|" . $tanggal_tanda_jadi;
    }
