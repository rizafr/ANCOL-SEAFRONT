...
<body onload="window.print()">
	<div id = "spp">
		...
		<table width="100%" border="0" cellspacing="0" class="pad kata_profil">
			...
			<tr>
				<td class="garis_isian"><a>asdsd</a></td>
				<td></td>
		...
		<table width="70%" border="0" cellspacing="0" class="pad kata_profil">
				...
				<tr>
					<td class="garis_isian"><a>asdsd</a></td>
					<td class="garis_isian"><a>asdas</a></td>
				</tr>
		</table>
		...
		<table width="100%" border="0" cellspacing="0" class="pad kata_profil">
				<tr>
					...
					<td width="2%"></td>
					<td width="18%" class="garis_isian"><a>asdsd</a></td>
					<td width="2%"></td>
				...
				<tr>
					<td>3. Lantai</td>
					<td></td>
					<td class="garis_isian"><a>asdasd</a></td>
					<td></td>
					<td><a></a></td>
					<td></td>
					<td class="garis_isian"><a></a></td>
		...
		<table cellspacing="0" width="100%" border="0" class="kata_profil pad ttd">
			...
			<tr>
				<td class="border_table">Irvan Maulana</td>
	...
	<div id="table">
		...
		<a class = "keterangan pad_kpr">KPR X36</a>
		<table class="kata_profil pad_kpr ttd" id = 'table_kpr' width="55%" cellspacing="0">
			...
			<tr>
				...
				<td class="border_table">30-May-2015</td>
				<td class="border_table">Rp 20.000.000</td>
			</tr><?php
			}
			?>
			<tr>
